...
- [ ] Analyser prix d'achat par quartier (Woodstock, Observatory, City Bowl, Sea Point, Green Point)
- [ ] Comparer rendement locatif brut par zone (loyer annuel / prix achat)
...
- [ ] Lister les sites d'annonces pour l'achat (Property24, Private Property, etc.)
- [ ] Contacter des agents immobiliers locaux
- [ ] Etudier la fiscalite (impot sur revenus locatifs, plus-value)
- [ ] Calculer cash-flow net apres charges (levy, rates, assurance, gestion)
